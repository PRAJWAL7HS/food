                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>We"ve got your covered with menus from over 50+ delivery restaurants online.</p>
                                </div>
                            </div>
                        </div>
															...
															<div class="row">
																...
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	...
																	<div class="bottom-part">
																		<div class="cost"><i class="fa fa-check"></i> Min Rs. 100.00</div>
																		<div class="mins"><i class="fa fa-motorcycle"></i> 30-40 min</div>
        ...
        <footer class="footer">
            <div class="container">
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            ...
                            <h5>Phone: <a href="tel:+080000012222">080 12345 12345</a></h5> </div>
                ...
                <!-- bottom footer ends -->
                            ...
                            <footer class="footer"><center>© 2019 All rights reserved.Food pickup Dept. of CSE MRIT <br>©Developed and Maintained by Guru Prasad Yashas and Prajwal</center>  </footer>
        </footer>
        <!-- end:Footer -->
    </div>
    <!--/end:Site wrapper -->
